    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Session', models.CharField(choices=[('30min', '30min'), ('45min', '45min'), ('60min', '60min')], max_length=10)),
                ('frequency', models.CharField(choices=[('weekly', 'weekly'), ('biweekly', 'biweekly')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CounsilerName', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='new_app.counsiler')),
                ('PatientName', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='new_app.patient')),
            ],
        ),
    ]
